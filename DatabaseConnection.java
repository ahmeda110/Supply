...
public class DatabaseConnection {
	...
	String >> retrieveData(String tableName, String type) {
		...
		try {
			...
			furniture = new ArrayList < HashMap < String,
			String >> ();
			HashMap < String,
			String > parts = new HashMap < String,
			String > ();
	...
	/**
         ...
         */
	public ArrayList < HashMap < String,
	String >> getPossibleManufacturer(String itemTable) {
		...
		try {
			ArrayList < HashMap < String,
			String >> queryResultList = new ArrayList < HashMap < String,
			String >> ();
			HashMap < String,
			String > entry = null;
